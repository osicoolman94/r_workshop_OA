...
```{r}
my_mood <- c('Hello', 'I', 'Am', 'Excited')
my_mood
my_numbers <- c(1,1,2,3,5,8,13)
my_numbers
my_dec_numbers <- c(1.11, 2.22, 3.33, 4.44, 5.55, 6.66)
my_dec_numbers
my_logicals <- c(TRUE, TRUE, FALSE, TRUE, TRUE)
my_logicals
```
...
```{r}
all_numbers <- c(my_numbers, my_dec_numbers)
```
...
```{r}
hotdog_names[hotdog_2019 == max(hotdog_2019[hotdog_genders == 'female'])]
```
...
sd(hotdog_2019)
sd(c(hotdog_2019,NA))
sd(c(hotdog_2019,NA), na.rm = TRUE)
```
5.2) `min()` and `max()`

```{r}
min(hotdog_2019)
min(c(hotdog_2019,NA))
min(c(hotdog_2019,NA), na.rm = TRUE)

max(hotdog_2019)
max(c(hotdog_2019,NA))
max(c(hotdog_2019,NA), na.rm = TRUE)
```
5.3) `summary()`

```{r}
summary(hotdog_2019)
summary(c(hotdog_2019,NA))
summary(c(hotdog_2019,NA), na.rm = TRUE)
```
...
```{r}
table(hotdog_2019)
table(c(hotdog_2019,NA))
table(c(hotdog_2019,NA), na.rm = TRUE)
```
...
```{r}
head(hotdog_2019)
head(c(hotdog_2019,NA))
head(c(hotdog_2019,NA), na.rm = TRUE)

tail(hotdog_2019)
tail(c(hotdog_2019,NA))
tail(c(hotdog_2019,NA), na.rm = TRUE)
```
...
```{r}
length(hotdog_2019)
length(c(hotdog_2019,NA))
length(c(hotdog_2019,NA), na.rm = TRUE)
```
