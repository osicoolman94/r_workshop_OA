...
mean_ex_vector <- mean(example_vector)
round(mean_ex_vector,2)
```
...
```{r}
nerd_red %>% 
  filter(nerdy == 7 & gender == 2)
nrow()

nerd_red %>% 
  filter(nerdy == 1 & gender == 2)
nrow()

nerd_red %>% 
  filter(nerdy == 7 & gender == 1)

nerd_red %>% 
  filter(nerdy == 1 & gender == 1)
...
```{r}
nerd_red %>% 
  mutate(gender_new = gender - 1, .before = gender)
```
